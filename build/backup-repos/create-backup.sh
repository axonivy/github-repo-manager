...
function backup_escrow()
{
  ...
  cloneRepository $gitHubAxonIvyRepo 'case-map-editor'
  ...
  cloneRepository $gitHubAxonIvyRepo 'inscription-client'
  cloneRepository $gitHubAxonIvyRepo 'form-editor'
  cloneRepository $gitHubAxonIvyRepo 'variable-editor'
  cloneRepository $gitHubAxonIvyRepo 'dataclass-editor'
  cloneRepository $gitHubAxonIvyRepo 'database-editor'
  cloneRepository $gitHubAxonIvyRepo 'role-editor'
  ...
  cloneRepository $gitHubAxonIvyRepo 'neo'
  cloneRepository $gitHubAxonIvyRepo 'vscode-designer'
  ...
  cloneRepository $gitHubAxonIvyRepo 'process-editor'
  cloneRepository $gitHubAxonIvyRepo 'process-editor-core'
